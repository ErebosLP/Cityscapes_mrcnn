...
def main():
    ...
    threshold_pred = 0.10 # ab welchem threshold sollen predictions angezeigt werden
    ...
    for factor in resize_factor:
        ...
        checkpoint = torch.load('C:/Users/Jean-/sciebo/Documents/Masterprojekt/Code/model/Cityscapes_model/model_Cityscapes_version3_numEpochs500.pth')
        print('2')
        ...
        model.to(device)
        print('4')
        name_file = 'model_BlumenkohlDataset_numTrainIm490_Ergebnis_mitFactor' + str(factor) + 'versuch3_500epochs'
        ...
        # load test images
        print('5')
        dataset_test = CityscapeDataset('E:/Datasets/',"train", get_transform(train=False))
